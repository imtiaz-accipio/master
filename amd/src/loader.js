...
define(['jquery', './tether', 'core/event', 'core/custom_interaction_events'], function(jQuery, Tether, Event, customEvents) {
    ...
    M.util.js_pending('theme_master/loader:children');

    require(['theme_master/aria',
            'theme_master/pending',
            'theme_master/util',
            'theme_master/alert',
            'theme_master/button',
            'theme_master/carousel',
            'theme_master/collapse',
            'theme_master/dropdown',
            'theme_master/modal',
            'theme_master/scrollspy',
            'theme_master/tab',
            'theme_master/tooltip',
            'theme_master/popover'],
            function(Aria) {
        ...
        Aria.init();
        M.util.js_complete('theme_master/loader:children');
    });
